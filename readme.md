...
## AI use disclosure
`rankfilt.go` was translated from C++ by free ChatGPT.
`MonotonicGrainSeeker` was initially generated by free ChatGPT. 
Offline modes of `GrainReader`/`GrainWriter` and some tests in `dspio` package were generated by Claude Opus.

Everything else was written without use of AI. 
I'm unemployed and simply have no money for frontier models. 
Especially since I'm in Russia.
